...
void main() {
  testWidgets('Book button opens the QR booking dialog with the booking URL', (
    ...
    expect(expectedUrl, contains('#/web-booking?doctor=${doctor.placeId}'));
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      // Path + query shape: #/web-booking?doctor=<placeId>&token=...&name=...
      expect(bookingUrl, contains('#/web-booking?doctor=${doctor.placeId}'));
