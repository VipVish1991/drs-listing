...
//    }
    ...
    return _channel.invokeMethod('startTransaction', {
      ...
      // A null/empty response (some UPI apps return data without the
      // response extra) must not crash UpiResponse's split() — it maps to
      // an empty parse, which callers treat as 'failed'/'canceled'.
