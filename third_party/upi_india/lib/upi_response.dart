...
class UpiResponse {
  ...
  UpiResponse(String responseString) {
    ...
    for (int i = 0; i < _parts.length; ++i) {
      List<String> pair = _parts[i].split('=');
      // Guard against malformed segments — e.g. a trailing '&' produces an
      // empty part with no '='. Indexing [1] unconditionally used to throw
      // RangeError, which mapped a possibly-PAID transaction to 'failed'.
